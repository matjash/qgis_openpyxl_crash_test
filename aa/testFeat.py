...
from qgis.core import QgsProcessingAlgorithm, QgsProcessingParameterFeatureSource, QgsProcessingParameterFile
import openpyxl

class testFeatAlgorithm(QgsProcessingAlgorithm):
    ...
    def createInstance(self):
        return testFeatAlgorithm()

    def name(self):
        return 'minimal_test_feat'

    def displayName(self):
        return self.tr('Minimal Test FS')
    ...
    def initAlgorithm(self, config=None):
        ...
        self.addParameter(QgsProcessingParameterFeatureSource(self.INPUT_LAYER, 'Input FS', defaultValue=None))
